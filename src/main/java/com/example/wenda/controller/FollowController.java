...
public class FollowController {
    ...
    public String unfollowUser(@RequestParam("userId")int userId){
        ...
        eventProducer.fireEvent(new EventModel(EventType.UNFOLLOW).setActorId(hostHolder.getUser().getId()).setEntityId(userId).setEntityType(EntityType.ENTITY_USER).setEntityOwnerId(userId));
        return WendaUtil.getJSONString(ret ? 0 : 1, String.valueOf(followService.getFolloweeCount(hostHolder.getUser().getId(), EntityType.ENTITY_USER)));
    }
    ...
    public String followQuestion(@RequestParam("questionId")int questionId){
        ...
        eventProducer.fireEvent(new EventModel(EventType.FOLLOW).setActorId(hostHolder.getUser().getId()).setEntityId(questionId).setEntityType(EntityType.ENTITY_QUESTION).setEntityOwnerId(q.getUserId()));
    ...
    public String unfollowQuestion(@RequestParam("questionId")int questionId){
        ...
        eventProducer.fireEvent(new EventModel(EventType.UNFOLLOW).setActorId(hostHolder.getUser().getId()).setEntityId(questionId).setEntityType(EntityType.ENTITY_QUESTION).setEntityOwnerId(q.getUserId()));
    ...
    public String followees(Model model, @PathVariable("uid")int userId){
        ...
        model.addAttribute("followerCount", followService.getFolloweeCount(EntityType.ENTITY_USER, userId));
        model.addAttribute("curUser", userService.getUser(userId));
